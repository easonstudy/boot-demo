...
public class BootsolrApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(BootsolrApplication.class, args);
	}
	...
	public void run(String... strings) throws Exception {
		...
		//repository.save的 如何存到solr的@SolrDocument的？？？？
