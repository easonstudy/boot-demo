...
import com.guo.sso.repository.JedisClient;
import com.guo.sso.repository.UserRepository;
import com.guo.sso.utils.CookieUtils;
import com.guo.sso.utils.ItdragonUtils;
import com.guo.sso.utils.JsonUtils;
...
public class UserService {
    ...
    public ItdragonResult userLogin(String account, String password,
        ...
        if (user == null || !ItdragonUtils.decryptPassword(user, password)) {
